<footer class="brk-footer brk-footer-1 position-relative">
        <div class="brk-footer__wrapper brk-footer__wrapper_shadow">
                    ...
                    <div class="brk-base-bg-gradient-40-no-opacity h-100">
                        <div class="row no-gutters">
                            <div class="col-12 col-md-7">
                                <div class="all-light text-center text-sm-left pt-md-0 pb-md-90 pt-40 pb-35 pl-md-60 pl-15 pr-15 pr-md-30">
                            ...
                            <div class="col-12 col-md-5">
                                <div class="pt-65 pt-xs-20 pb-50 pr-30">
                                    ...
                                    <div class="brk-styled-twitter-3 pr-xs-15 pl-xs-15">
                                        <a href="https://twitter.com/Dpcpkb_Cimahi" class="twitter-timeline" data-tweet-limit="2" data-chrome="noheader,transparent,nofooter,noborders" data-theme="dark"></a>
                                    </div>
                                </div>
                            </div>
                        </div>
            ...
            <div class="pt-60 brk-bg-grad border-bottom-3 brk-border-color-light brk-shadow-light">
                <div class="container">
                    <div class="brk-dashed-logo mb-20">
                        <span class="brk-dashed-logo__line"></span>
                        <a class="brk-dashed-logo__link ml-25 mr-25">
                            <img src="{{ asset('assets/img/logo-light.png') }}" height="31" width="170" alt="logo">
                        </a>
                        <span class="brk-dashed-logo__line"></span>
                    </div>
                    ...
                    <div class="brk-footer__rights pt-15 pb-20 text-center">
                        <p class="font__family-open-sans font__size-14 font__weight-normal line__height-14">
                            © 2019 DPC PKB Kota Cimahi All rights reserved
                        </p>
                    </div>
                </div>
            </div>
