		...
		<div class="row">
			<div class="col-12 col-lg-8 col-xl-9 order-xs-2 order-lg-1">
				<div class="brs-posts-container brs-posts-container_right-divider">
					<div class="mb-60">
						<div>
							<a href="{{ url('/forum') }}" class="font__size-md-22 font__size-20 line-height-1-5 font__weight-bold"><i class="fa fa-arrow-circle-left mt-1 mr-3"></i>Kembali Ke Diskusi</a>	
						</div>
