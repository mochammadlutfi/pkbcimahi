					...
					<div class="col-12 col-lg-6">
						<div class="pt-25 pb-35 position-static position-lg-relative breadcrumbs__subtitle">
							...
							<ol class="breadcrumb font__family-montserrat font__size-15 line__height-16 brk-white-font-color">
								...
								<li class="active">Sejarah Pendirian PKB</li>
							</ol>
						</div>
					</div>
				</div>
					...
					<div class="mb-60">
						<div class="brs-post brs-post_slider" data-brk-library="component__blog">
							...
							<div class="brs-post__description">
								...
								<p class="brs-post__description__paragraph text-left font__family-open-sans font__size-16 font__weight-normal line__height-26 mb-15">
									Maka dengan memohon rahmat, taufiq, hidayah dan inayah Allah SWT serta didorong oleh semangat keagamaan, kebangsaan dan demokrasi, kami warga Jam’iyah Nahdlatul Ulama dengan ini menyatakan berdirinya partai politik yang bersifat kejuangan, kebangsaan, terbuka dan demokratis yang diberi nama <b>Partai Kebangkitan Bangsa (PKB)</b>.
								</p>

								<h2 class="brk-post-full__title font__family-montserrat font__size-lg-24 font__size-26 line-height-1 font__weight-bold mt-20 mb-35">
										SEJARAH PENDIRIAN PARTAI KEBANGKITAN BANGSA (PKB)</h2>

								<p class="brs-post__description__paragraph text-left font__family-open-sans font__size-16 font__weight-normal line__height-26 mb-15">
									Di bawah komando Ketua Umum Dewan Pengurus Pusat Partai Kebangkitan Bangsa (DPP PKB) H. Abdul Muhaimin Iskandar, perolehan suara PKB dalam Pemilihan Umum (Pemilu) 2014 kembali meroket. Dengan pencapaian 11.292.151 suara (9,04%) atau setara 47 kursi di DPR RI. Padahal, lima tahun sebelumnya atau Pemilu priode 2004-2009, PKB hanya memperoleh 5.146.302 suara (4,95 persen) dan mendapat 28 kursi DPR RI.
								</p>
