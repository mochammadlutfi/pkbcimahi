				...
				<div class="row brk-gutters-5">
					...
					<div class="col-12 col-md-4">
						<div class="brk-portfolio-galleries__card" data-brk-library="component__portfolio_galleries">
							<img class="brk-abs-img lazyload" alt="{{ $g->nama }}" src="data:image/gif;base64,R0lGODlhAQABAAAAACH5BAEKAAEALAAAAAABAAEAAAICTAEAOw==" data-src="{{ asset('uploads/'.$g->foto) }}">
							<div class="brk-portfolio-galleries__label pt-60 pl-70 pr-60 pb-50">
								<h2 class="font__family-roboto font__size-32 font__weight-thin mb-2">{{ $g->nama }} </h2>
