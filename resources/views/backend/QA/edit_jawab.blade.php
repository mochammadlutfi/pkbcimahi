                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="form-group row">
                            <div class="col-12">
                                <textarea class="form-control" id="field-deskripsi" name="deskripsi" placeholder="Masukan Deskripsi Event" rows="8"><?= $a->deskripsi ?></textarea>
